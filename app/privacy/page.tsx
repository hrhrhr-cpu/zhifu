      ...
      <div className="pt-32 pb-12 md:pt-40 md:pb-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-lg text-gray-600">
            ...
            <p className="mb-4">
              全网影视会员（"我们"、"我们的"或"本网站"）尊重您的隐私，并致力于保护您的个人信息。本隐私政策描述了我们在您访问网站时如何收集、使用和共享您的信息。
            </p>

            <h2 className="h3 font-playfair-display mb-4 mt-8">我们收集的信息</h2>
            <p className="mb-2">我们可能收集以下类型的信息：</p>
            <ul className="list-disc list-inside mb-4 space-y-2">
              <li><strong className="font-medium text-gray-900">个人信息</strong>：包括您的姓名、电子邮件地址、电话号码等您在注册账户、订阅会员或填写联系表单时提供的信息。</li>
