...
export default function Hero() {
  return (
    <section className="relative">
      {/* Bg */}
      <div
        className="absolute inset-0 rounded-br-[100px] bg-gray-50 pointer-events-none -z-10"
        aria-hidden="true"
      />
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[640px]">
              ...
              <p
                ...
                data-aos-delay="200"
              >
                海量高清电影、经典剧集、独家纪录片，一个会员即可无限畅看，支持手机、电脑、电视多端同步。
              </p>
              {/* Buttons */}
              <div
              ...
              >
                <div>
                  ...
                  <div className="text-gray-500">影视分类</div>
                </div>
                <svg
                ...
                <div>
                  ...
                  <div className="text-gray-500">独家片源</div>
                </div>
                <svg
                  className="fill-gray-300"
                  width="14"
                ...
                <div>
                  ...
                  <div className="text-gray-500">精选影片</div>
                </div>
              </div>
            </div>
            {/* Image */}
